...
class Results(object):
	...
	def get_type(self, type):
		if type == "PATIENTS" or type == "PATIENT":
			return self.patients
		if type == "DOCTOR" or type == "DOCTORS":
			return self.doctors 
		if type == "DIAGNOSIS":
			return self.diagnosis
		if type == "EVENT":
...
#
#
t = tableDecleration( "PATIENTS", "BIRTHYEAR", results)
s = tableDecleration( "PATIENTS", "DIAGNOSIS", results)
v = tableDecleration( "DOCTORS", "ID", results)
printTable(t)
printTable(s)
printTable(v)
