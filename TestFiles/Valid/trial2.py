...
events = ["*"]
filters = "and (Patient.PatientSerNum >= 10 and Patient.PatientSerNum <= 1000 ) and ((PERIOD.LastUpdated >= \"2013-01-31 00:00:00\" and PERIOD.LastUpdated <= \"2015-01-01  23:59:59\")) and ((TIME(PERIOD.LastUpdated) >=\"09:00:00\" and TIME(PERIOD.LastUpdated) <=\"09:59:59\")) and (DAYOFWEEK(PERIOD.LastUpdated) = 4 or DAYOFWEEK(PERIOD.LastUpdated) = 3 or DAYOFWEEK(PERIOD.LastUpdated) = 6 or DAYOFWEEK(PERIOD.LastUpdated) = 2 or DAYOFWEEK(PERIOD.LastUpdated) = 5) "
