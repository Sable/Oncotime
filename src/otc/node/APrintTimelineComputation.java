...
public final class APrintTimelineComputation extends PComputation
{
    private TTIdentifier _tIdentifier_;

    public APrintTimelineComputation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrintTimelineComputation(
            cloneNode(this._tIdentifier_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPrintTimelineComputation(this);
    }
