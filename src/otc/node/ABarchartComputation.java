...
public final class ABarchartComputation extends PComputation
{
    private TTIdentifier _tIdentifier_;

    public ABarchartComputation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABarchartComputation(
            cloneNode(this._tIdentifier_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseABarchartComputation(this);
    }
