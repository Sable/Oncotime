...
public final class APrintLengthComputation extends PComputation
{
    private TTIdentifier _tIdentifier_;

    public APrintLengthComputation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrintLengthComputation(
            cloneNode(this._tIdentifier_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPrintLengthComputation(this);
    }
