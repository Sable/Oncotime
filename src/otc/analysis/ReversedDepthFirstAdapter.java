...
public class ReversedDepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inARangeListItemTypedList(ARangeListItemTypedList node)
    {
        defaultIn(node);
    }

    public void outARangeListItemTypedList(ARangeListItemTypedList node)
    {
        defaultOut(node);
    }
    ...
    {
        inARangeListItemTypedList(node);
        if(node.getTypedList() != null)
        {
            node.getTypedList().apply(this);
        }
        ...
        outARangeListItemTypedList(node);
    }
